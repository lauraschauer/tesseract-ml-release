...
## Make Dataset
data:
	wget -O ./data/raw/drebin-features.tar.gz https://www.dropbox.com/s/i7q8ysi5agi6n0f/drebin-features.tar.gz
	tar -zxf ./data/raw/drebin-features.tar.gz --directory ./data/processed/
	rm ./data/raw/drebin-features.tar.gz
